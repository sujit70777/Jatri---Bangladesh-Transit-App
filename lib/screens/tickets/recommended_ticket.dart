            ...
            children: [
              ...
              Container(
                ...
                child: const Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Single ticket', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
                    Text('Valid for your full route, no transfer fee', style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
                    SizedBox(height: 10),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('This trip', style: TextStyle(color: AppColors.textMuted, fontSize: 12)), Text('Tk 60', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700))],
                    ),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: const Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Take this route often?', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13)),
              ...
              Center(
                child: TextButton(
                  ...
                  child: const Text('See all ticket options', style: TextStyle(color: AppColors.textMuted)),
                ),
              ),
            ],
          ),
